Dưới đây là nội dung toàn bộ bài Lab 4 được chuyển đổi sang định dạng Markdown để bạn dễ dàng lưu trữ và sử dụng.
...
2. [Bổ sung thêm các rule của bạn tại đây]
</rules>
...
- [Bổ sung thêm các constraint của bạn tại đây]
</constraints>
```
...
# TODO: Sinh viên triển khai khai báo edges
